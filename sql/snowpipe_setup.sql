...
CREATE STORAGE INTEGRATION CRIME_DATA_INTEGRATION
  ...
  ENABLED = TRUE
  STORAGE_ALLOWED_LOCATIONS = ('gcs://data-police-uk')
;
...
CREATE NOTIFICATION INTEGRATION CRIME_DATA_NOTIFICATION_INTEGRATION
  ...
  ENABLED = true
  GCP_PUBSUB_SUBSCRIPTION_NAME = 'projects/crime-data-uk/subscriptions/crime-data-bucket-subscriber';
